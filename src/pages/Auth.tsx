  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        toast.success("Sila semak email anda untuk pengesahan.");
      }
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 h-11 rounded-lg bg-card card-shadow text-foreground text-sm font-medium hover:card-shadow-hover transition-all"
        >
